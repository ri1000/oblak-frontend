<script lang="ts">
    ...
    async function uploadFile() {
      if (selectedFile) {
        ...
        try {
          const response = await axios.post < string > ('http://34.154.242.32/api/calculate', formData);
  ...
  <body>
    <div class="container">
      <h1>Calculate standard deviation of an input file using a <span style="color: chocolate;">traditional server!</span></h1>
      <hr>
